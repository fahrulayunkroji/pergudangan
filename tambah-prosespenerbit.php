...
if(isset($_POST['tambah'])){
	...
	$input = mysql_query("INSERT INTO tb_penerbit VALUES(NULL, '$id_penerbit', '$nm_penerbit', '$negara', '$kota')") or die(mysql_error());
	...
	if($input){
		...
		echo '<a href="tambahpenerbit.php">Kembali</a>';	//membuat Link untuk kembali ke halaman tambah
